...
# Settings > Date & Time > Change date and time formats > First day of week 

$RegCommands =
'add "HKCU\Control Panel\International" /v iFirstDayOfWeek /t REG_SZ /d 0 /f'
