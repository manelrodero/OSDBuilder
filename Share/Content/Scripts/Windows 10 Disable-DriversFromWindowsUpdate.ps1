...
#
#   OSBuilder Script
#   Disable-DriversFromWindowsUpdate.ps1
...
$RegCommands =
'add HKLM\Software\Policies\Microsoft\Windows\DriverSearching /v SearchOrderConfig /t REG_DWORD /d 0 /f',
'add HKLM\Software\Policies\Microsoft\Windows\WindowsUpdate /v ExcludeWUDriversInQualityUpdate /t REG_DWORD /d 1 /f'
