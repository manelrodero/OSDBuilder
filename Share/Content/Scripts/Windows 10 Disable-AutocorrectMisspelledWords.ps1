...
#
#   OSBuilder Script
#   Disable-AutocorrectMisspelledWords.ps1
...
# https://admx.help/?Category=Windows_10_2016&Policy=Microsoft.Policies.Globalization::TurnOffAutocorrectMisspelledWords

$RegCommands =
'add "HKCU\Software\Policies\Microsoft\Control Panel\International" /v "TurnOffAutocorrectMisspelledWords" /t REG_DWORD /d 1 /f'
