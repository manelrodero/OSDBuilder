...
# https://twitter.com/MyNameIsMurray/status/1385285753484189697
# https://twitter.com/byteben/status/1402499311473246209

$RegCommands =
'add HKCU\Software\Microsoft\Windows\CurrentVersion\Feeds /v ShellFeedsTaskbarViewMode /t REG_DWORD /d 2 /f',
'add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Feeds" /v EnableFeeds /t REG_DWORD /d 0 /f'
