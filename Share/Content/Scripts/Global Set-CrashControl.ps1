...
# CrashDumpEnabled = 2 -> Volcado de memoria del kernel

$RegCommands =
'add "HKLM\SYSTEM\ControlSet001\Control\CrashControl" /v AutoReboot /t REG_DWORD /d 0 /f',
'add "HKLM\SYSTEM\ControlSet001\Control\CrashControl" /v CrashDumpEnabled /t REG_DWORD /d 2 /f'
