...
#
#   OSBuilder Script
#   Force-WinUserLanguageList.ps1
#
#   Requires:
#   ..\ExtraFiles\Windows 10 Scripts\Scripts\ForceWinUserLanguageList.ps1
...
$RegCommands =
'add HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\RunOnce /v "!ForceWinUserLanguageList" /t REG_SZ /d "powershell.exe -NoLogo -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File C:\Scripts\Force-WinUserLanguageList.ps1" /f'
