...
# Group Policies: Computer Configuration – Administrative Templates – System - Display Shutdown Event Tracker

$RegCommands =
'add "HKLM\SOFTWARE\Policies\Microsoft\Windows NT\Reliability" /v ShutDownReasonOn /t REG_DWORD /d 0 /f'
