...
# https://winaero.com/always-show-tray-icons-windows-10/

$RegCommands =
'add "HKCU\Software\Software\Microsoft\Windows\CurrentVersion\Explorer" /v "EnableAutoTray" /t REG_DWORD /d 0x00 /f'
