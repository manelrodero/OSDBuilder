...
# Windows 10 - Disable Web Search in Start Menu
# https://www.bennetrichter.de/en/tutorials/windows-10-disable-web-search/

# DisableWebSearch doesn't work on 2004
# https://github.com/Disassembler0/Win10-Initial-Setup-Script/issues/300

<# Windows 10 < 1803
$RegCommands =
'add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Search" /v DisableWebSearch /t REG_DWORD /d 1 /f'
#>
